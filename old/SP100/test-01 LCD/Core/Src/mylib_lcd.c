...
void SP100_LCD_Update(void)
{
	...
	//SP100_LCD_SEG_ON(OT_Scnd_Seg_A);
	//SP100_LCD_SEG_ON(OT_Scnd_Seg_B);
	//SP100_LCD_SEG_ON(OT_Scnd_Seg_C);
	//SP100_LCD_SEG_ON(OT_Scnd_Seg_D);
	//SP100_LCD_SEG_ON(OT_Scnd_Seg_E);
	//SP100_LCD_SEG_ON(OT_Scnd_Seg_F);
	//SP100_LCD_SEG_ON(Fan_BLI6);
