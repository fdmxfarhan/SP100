...
const   uint8_t   AUTO[]            = {0x05,0x10};
const   uint8_t   DEF[]             = {0x04,0x80};
const   uint8_t   R_DEF[]           = {0x04,0x20};
const   uint8_t   AC[]              = {0x07,0x10};

const   uint8_t   PAX[]             = {0x05,0x02};
const   uint8_t   Face[]            = {0x05,0x04};
const   uint8_t   Foot[]            = {0x05,0x01};
const   uint8_t   Def[]             = {0x04,0x40};
...
const   uint8_t   Fan_BLI5[]        = {0x04,0x02};
const   uint8_t   Fan_BLI6[]        = {0x04,0x08};
const   uint8_t   Fan_BLI7[]        = {0x04,0x04};
const   uint8_t   Fan_BLI8[]        = {0x04,0x04};
const   uint8_t   Fan_BLO1[]        = {0x03,0x01};
const   uint8_t   Fan_BLO2[]        = {0x03,0x08};
const   uint8_t   Fan_BLO3[]        = {0x03,0x02};
const   uint8_t   Fan_BLO4[]        = {0x03,0x08};
const   uint8_t   Fan_BLO5[]        = {0x03,0x08};
...
const   uint8_t   SP_Scnd_Seg_B[]   = {0x06,0x08};
const   uint8_t   SP_Scnd_Seg_C[]   = {0x06,0x40};
const   uint8_t   SP_Scnd_Seg_D[]   = {0x07,0x02};
const   uint8_t   SP_Scnd_Seg_E[]   = {0x07,0x04};
const   uint8_t   SP_Scnd_Seg_F[]   = {0x07,0x40};
...
const   uint8_t   OT_Scnd_Seg_F[]   = {0x01,0x40};
const   uint8_t   OT_Scnd_Seg_G[]   = {0x02,0x80};
