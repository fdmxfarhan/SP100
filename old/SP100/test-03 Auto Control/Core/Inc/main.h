...
/* Private defines -----------------------------------------------------------*/
#define Cabin_Sens_Pin GPIO_PIN_0
#define Cabin_Sens_GPIO_Port GPIOA
#define Water_Sens_Pin GPIO_PIN_1
#define Water_Sens_GPIO_Port GPIOA
#define Ambient_Sens_Pin GPIO_PIN_2
#define Ambient_Sens_GPIO_Port GPIOA
#define Evap_Sens_Pin GPIO_PIN_3
#define Evap_Sens_GPIO_Port GPIOA
#define Airmix_FB_Pin GPIO_PIN_6
#define Airmix_FB_GPIO_Port GPIOA
#define BL_Voltage_Pin GPIO_PIN_7
#define BL_Voltage_GPIO_Port GPIOA
...
#define BLOWER_MODE 0    // 0: old   1: new
