...
{
	if(SP100_OUT_TEMP_READY == NOT_READY){
		SP100_LCD_SEG_OFF(OT_Scnd_Seg_A);
		SP100_LCD_SEG_OFF(OT_Scnd_Seg_B);
		SP100_LCD_SEG_OFF(OT_Scnd_Seg_C);
		SP100_LCD_SEG_OFF(OT_Scnd_Seg_D);
		SP100_LCD_SEG_OFF(OT_Scnd_Seg_E);
		SP100_LCD_SEG_OFF(OT_Scnd_Seg_F);
		SP100_LCD_SEG_ON( OT_Scnd_Seg_G);
		
		SP100_LCD_SEG_OFF(OT_Frst_Seg_A);
		SP100_LCD_SEG_OFF(OT_Frst_Seg_B);
		SP100_LCD_SEG_OFF(OT_Frst_Seg_C);
		SP100_LCD_SEG_OFF(OT_Frst_Seg_D);
		SP100_LCD_SEG_OFF(OT_Frst_Seg_E);
		SP100_LCD_SEG_OFF(OT_Frst_Seg_F);
		SP100_LCD_SEG_ON( OT_Frst_Seg_G);
	}
	else if(SP100_Ambient_Sensor > 0){
...
void SP100_LCD_Diag_State(void)
{
	...
	if(SP100_DIAG_State == DIAG_Sensor){
		if(SP100_DIAG_Sensor_Index == DIAG_Sensor_All){
			SP100_LCD_Print_Temp(510);
		}
		if(SP100_DIAG_Sensor_Index == DIAG_Sensor_Evap){
			if(SP100_Diag_Evap_State == DIAG_OK)
				SP100_LCD_Print_Temp(511);
			else{
				SP100_LCD_ALL_SEG(SEG_OFF);
				SP100_Delay(blink_Delay);
				SP100_LCD_Print_Temp(511);
				SP100_Delay(blink_Delay);
			}
		}
		if(SP100_DIAG_Sensor_Index == DIAG_Sensor_Cabin){
			if(SP100_Diag_Cabin_State == DIAG_OK)
				SP100_LCD_Print_Temp(512);
			else{
				SP100_LCD_ALL_SEG(SEG_OFF);
				SP100_Delay(blink_Delay);
				SP100_LCD_Print_Temp(512);
		...
		if(SP100_DIAG_Sensor_Index == DIAG_Sensor_Water){
			if(SP100_Diag_Water_State == DIAG_OK)
				SP100_LCD_Print_Temp(513);
			else{
				SP100_LCD_ALL_SEG(SEG_OFF);
				SP100_Delay(blink_Delay);
				SP100_LCD_Print_Temp(513);
		...
		if(SP100_DIAG_Sensor_Index == DIAG_Sensor_Ambient){
			if(SP100_Diag_Ambient_State == DIAG_OK)
				SP100_LCD_Print_Temp(514);
			else{
				SP100_LCD_ALL_SEG(SEG_OFF);
				SP100_Delay(blink_Delay);
				SP100_LCD_Print_Temp(514);
	...
	if(SP100_DIAG_State == DIAG_Actuator){
		if(SP100_DIAG_Actuator_Index == DIAG_Actuator_All)
			SP100_LCD_Print_Temp(520);
		if(SP100_DIAG_Actuator_Index == DIAG_Actuator_Airmix_Lock){
			if(SP100_Diag_Airmix_Lock_State == DIAG_OK)
				SP100_LCD_Print_Temp(521);
			else{
				SP100_LCD_ALL_SEG(SEG_OFF);
				SP100_Delay(blink_Delay);
				SP100_LCD_Print_Temp(521);
		...
		if(SP100_DIAG_Actuator_Index == DIAG_Actuator_Mode_Lock){
			if(SP100_Diag_Mode_Lock_State == DIAG_OK)
				SP100_LCD_Print_Temp(522);
			else{
				SP100_LCD_ALL_SEG(SEG_OFF);
				SP100_Delay(blink_Delay);
				SP100_LCD_Print_Temp(522);
		...
		if(SP100_DIAG_Actuator_Index == DIAG_Actuator_Airmix_Pot){
			if(SP100_Diag_Airmix_Pot_State == DIAG_OK)
				SP100_LCD_Print_Temp(523);
			else{
				SP100_LCD_ALL_SEG(SEG_OFF);
				SP100_Delay(blink_Delay);
				SP100_LCD_Print_Temp(523);
		...
		if(SP100_DIAG_Actuator_Index == DIAG_Actuator_Mode_Pot){
			if(SP100_Diag_Mode_Pot_State == DIAG_OK)
				SP100_LCD_Print_Temp(524);
			else{
				SP100_LCD_ALL_SEG(SEG_OFF);
				SP100_Delay(blink_Delay);
				SP100_LCD_Print_Temp(524);
