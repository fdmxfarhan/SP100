...
int main(void)
{
  /* USER CODE BEGIN 1 */
	...
	// Agha Ye nokte kheyli mohem:7
	// 	DMA initesh bayad ghable ADC bashe...!!!!!!!
	MX_DMA_Init();
  /* USER CODE END 1 */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_8|GPIO_PIN_9|TLE_CSN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PA8 PA9 TLE_CSN_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_8|GPIO_PIN_9|TLE_CSN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : PA10 PA11 Mode_SW_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_10|GPIO_PIN_11|Mode_SW_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
