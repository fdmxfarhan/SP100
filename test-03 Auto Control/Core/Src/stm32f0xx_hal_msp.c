...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PC5     ------> ADC_IN15
    */
    GPIO_InitStruct.Pin = Cabin_Sens_Pin|Water_Sens_Pin|Ambient_Sens_Pin|Evap_Sens_Pin
                          |GPIO_PIN_5|Airmix_FB_Pin|BL_Voltage_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC5     ------> ADC_IN15
    */
    HAL_GPIO_DeInit(GPIOA, Cabin_Sens_Pin|Water_Sens_Pin|Ambient_Sens_Pin|Evap_Sens_Pin
                          |GPIO_PIN_5|Airmix_FB_Pin|BL_Voltage_Pin);
