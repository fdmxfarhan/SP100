...
Blower_State		SP100_Blower_State			=	Blower_L1;
AC_State			SP100_AC_State				=	AC_OFF;
AC_Temp_State		SP100_AC_Temp_State			=	AC_Temp_ON;
...
Mode_SEG_State		SP100_R_DEF_SEG_State		=	Mode_SEG_ON;
/* DIAG_State ----------------------------------------------------------------*/
...
DIAG_Element_State	SP100_Diag_Evap_State 	  = DIAG_OK;
DIAG_Element_State	SP100_Diag_Water_State 	  = DIAG_OK;
DIAG_Element_State	SP100_Diag_Cabin_State 	  = DIAG_OK;
DIAG_Element_State	SP100_Diag_Ambient_State 	= DIAG_OK;

DIAG_Element_State	SP100_Diag_Airmix_Pot_State 	= DIAG_OK;
DIAG_Element_State	SP100_Diag_Mode_Pot_State 	= DIAG_OK;
DIAG_Element_State	SP100_Diag_Airmix_Lock_State 	= DIAG_OK;
DIAG_Element_State	SP100_Diag_Mode_Lock_State 	= DIAG_OK;



OUT_TEMP_READY SP100_OUT_TEMP_READY = NOT_READY;
...
float		SP100_Ambient_Sensor=30;				// Ambient_Sensor
float		SP100_IGN_Volt;							// Ignition Voltage
...
float		SP100_Blower_Dest_Volt1 = 0;	

struct 	CCU_Elements_State SP100_CCU_Elements_State;
int 		SP100_RDEF_Start_Time;